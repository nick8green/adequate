...
//     (containerStartTimeModule as any).containerStartTime = {};
//     (httpRequestCountModule as any).httpRequestCounter = {};
//     (responseTimeModule as any).responseTime = {};
//     (cumulativeLayoutShiftModule as any).cls = {};
//     (firstContentfulPaintModule as any).fcp = {};
//     (firstInputDelayModule as any).fid = {};
//     (interactionToNextPaintModule as any).inp = {};
//     (largestContentfulPaintModule as any).lcp = {};
//     (timeToFirstBiteModule as any).ttfb = {};
//   });
